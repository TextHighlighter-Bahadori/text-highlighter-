...
public class ClojureTokenizerService : IClojureTokenizerService
{
    ...
    private Token NextToken()
    {
        ...
        if (char.IsDigit(current) ||
            (current == '-' && _position + 1 < _input.Length && char.IsDigit(_input[_position + 1])))
            return ReadNumber();
    ...
    private Token ReadNumber()
    {
        ...
        while (_position < _input.Length && (char.IsDigit(_input[_position]) || _input[_position] == '.' ||
                                             ...
                                             _input[_position] == 'M' ||
                                             _input[_position] == 'N' || _input[_position] == '/' ||
                                             _input[_position] == 'r'))
        {
            sb.Append(_input[_position]);
            _position++;
